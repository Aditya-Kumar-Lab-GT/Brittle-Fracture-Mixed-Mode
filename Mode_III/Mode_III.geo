...
Point(5) = {0, 0, Lz, 0.8};     
Point(6) = {Lx, 0, Lz, 0.8};    
Point(7) = {Lx, Ly, Lz, 0.8};   
Point(8) = {0, Ly, Lz, 0.8};   

Point(9) = {0, Ly/2-h/2, Lz, 0.8};     
Point(10) = {0, Ly/2+h/2, Lz, 0.8};    
Point(11) = {CrackZ, Ly/2, Lz, 0.8};  

Point(12) = {0, Ly/2-h/2, 0, 0.8};     
Point(13) = {0, Ly/2+h/2, 0, 0.8};    
Point(14) = {CrackZ, Ly/2, 0, 0.8};   
...
Field[1] = Box;
Field[1].VIn = 0.8; //change this to .025
Field[1].VOut = 0.8;
Field[1].XMin = CrackZ-.5;
Field[1].XMax = .8*Lx;
Field[1].YMin = Ly/2-3;
Field[1].YMax = Ly/2+3;
Field[1].ZMin = 0;
